      ...
      >
        ...
        <div className="w-full px-1 py-5">
          <ul className="flex flex-col w-full items-start gap-2">
            ...
            {canAccess(["Company Owner", "Marketing Manager"]) && (
              <li
                className="hover:bg-black w-full hover:text-white p-2 rounded-lg"
            ...
            {canAccess(["Company Owner"]) && (
              ...
              >
                <Button
                  label="SuggestionBox"
                  icon={
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-archive-restore-icon lucide-archive-restore">
            ...
            <li className="hover:bg-black flex gap-3 w-full  justify-center hover:text-white p-2 rounded-lg">
